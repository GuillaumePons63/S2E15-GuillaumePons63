...
const CreateProduct = () => {
    ...
    const onSubmit = e => {
        ...
        data.append('description', formData.description); // On fait ça pour quill
    ...
    return (
        <div className="container mt-5 mb-5">
            <div className="row">
                ...
                <p>
                    il faut : quand on 'submit' le form, on va devoir soit
                    mettre à jour, soit créer un produit, les données de la
                    requête seront les mêmes, l'url changera ainsi que la
                    méthode (POST, PATCH)
                </p>
            </div>
                ...
                <ul>
                    {productState?.products ? (
                        productState?.products.map(prod => (
                            <li key={prod.id}>
                                <Link
                                    onClick={e => onUpdateClick(prod, e)}
                                    to={prod.title}
                                >
                                    {prod.title}
                                </Link>
            ...
            >
                ...
                <div className="form-group FormGroup">
                    <div className="FormRow">
                        <label
                            className="FormRowLabel form-label"
                            htmlFor="category_id"
                        >
                            Category
                        </label>
                        ...
                        >
                            <option defaultValue>
                                Cliquer pour sélectionner la catégorie du
                                produit
                            </option>
